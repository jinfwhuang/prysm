...
func (x *UpdateResponse) GetUpdates() []*LightClientUpdate {
	if x != nil {
		return x.Updates
	}
	return nil
...
type SkipSyncResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Update *SkipSyncUpdate `protobuf:"bytes,1,opt,name=update,proto3" json:"update,omitempty"`
}

func (x *SkipSyncResponse) Reset() {
	*x = SkipSyncResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SkipSyncResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SkipSyncResponse) ProtoMessage() {}

func (x *SkipSyncResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_light_client_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SkipSyncResponse.ProtoReflect.Descriptor instead.
func (*SkipSyncResponse) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_light_client_proto_rawDescGZIP(), []int{6}
}

func (x *SkipSyncResponse) GetUpdate() *SkipSyncUpdate {
	if x != nil {
		return x.Update
	}
	return nil
...
var file_proto_prysm_v1alpha1_light_client_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0x54, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18,
	...
	,
	...
	,
...
var file_proto_prysm_v1alpha1_light_client_proto_goTypes = []interface{}{
	...
	(*UpdateResponse)(nil),    // 3: ethereum.eth.v1alpha1.UpdateResponse
	(*SkipSyncRequest)(nil),   // 4: ethereum.eth.v1alpha1.SkipSyncRequest
	(*UpdatesResponse)(nil),   // 5: ethereum.eth.v1alpha1.UpdatesResponse
	(*SkipSyncResponse)(nil),  // 6: ethereum.eth.v1alpha1.SkipSyncResponse
...
var file_proto_prysm_v1alpha1_light_client_proto_depIdxs = []int32{
	7,  // 0: ethereum.eth.v1alpha1.ClientSnapshot.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	8,  // 1: ethereum.eth.v1alpha1.ClientSnapshot.current_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	8,  // 2: ethereum.eth.v1alpha1.ClientSnapshot.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	7,  // 3: ethereum.eth.v1alpha1.LightClientUpdate.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	8,  // 4: ethereum.eth.v1alpha1.LightClientUpdate.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	7,  // 5: ethereum.eth.v1alpha1.LightClientUpdate.finality_header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	7,  // 6: ethereum.eth.v1alpha1.SkipSyncUpdate.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	8,  // 7: ethereum.eth.v1alpha1.SkipSyncUpdate.current_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	8,  // 8: ethereum.eth.v1alpha1.SkipSyncUpdate.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	7,  // 9: ethereum.eth.v1alpha1.SkipSyncUpdate.finality_header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	1,  // 10: ethereum.eth.v1alpha1.UpdateResponse.updates:type_name -> ethereum.eth.v1alpha1.LightClientUpdate
	1,  // 11: ethereum.eth.v1alpha1.UpdatesResponse.updates:type_name -> ethereum.eth.v1alpha1.LightClientUpdate
	2,  // 12: ethereum.eth.v1alpha1.SkipSyncResponse.update:type_name -> ethereum.eth.v1alpha1.SkipSyncUpdate
	9,  // 13: ethereum.eth.v1alpha1.LightClient.Updates:input_type -> google.protobuf.Empty
	4,  // 14: ethereum.eth.v1alpha1.LightClient.SkipSyncUpdate:input_type -> ethereum.eth.v1alpha1.SkipSyncRequest
	3,  // 15: ethereum.eth.v1alpha1.LightClient.Updates:output_type -> ethereum.eth.v1alpha1.UpdateResponse
	4,  // 16: ethereum.eth.v1alpha1.LightClient.SkipSyncUpdate:output_type -> ethereum.eth.v1alpha1.SkipSyncRequest
...
func (c *lightClientClient) Updates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UpdateResponse, error) {
	out := new(UpdateResponse)
	err := c.cc.Invoke(ctx, "/ethereum.eth.v1alpha1.LightClient/Updates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightClientClient) SkipSyncUpdate(ctx context.Context, in *SkipSyncRequest, opts ...grpc.CallOption) (*SkipSyncRequest, error) {
	out := new(SkipSyncRequest)
	err := c.cc.Invoke(ctx, "/ethereum.eth.v1alpha1.LightClient/SkipSyncUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightClientServer interface {
	Updates(context.Context, *empty.Empty) (*UpdateResponse, error)
	SkipSyncUpdate(context.Context, *SkipSyncRequest) (*SkipSyncRequest, error)
}
...
func (*UnimplementedLightClientServer) Updates(context.Context, *empty.Empty) (*UpdateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Updates not implemented")
}
func (*UnimplementedLightClientServer) SkipSyncUpdate(context.Context, *SkipSyncRequest) (*SkipSyncRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SkipSyncUpdate not implemented")
}
...
func _LightClient_Updates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightClientServer).Updates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.eth.v1alpha1.LightClient/Updates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightClientServer).Updates(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _LightClient_SkipSyncUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkipSyncRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightClientServer).SkipSyncUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.eth.v1alpha1.LightClient/SkipSyncUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightClientServer).SkipSyncUpdate(ctx, req.(*SkipSyncRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _LightClient_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Updates",
			Handler:    _LightClient_Updates_Handler,
		},
		{
			MethodName: "SkipSyncUpdate",
			Handler:    _LightClient_SkipSyncUpdate_Handler,
		},
	},
