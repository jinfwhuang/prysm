...
func (x *SkipsyncRequest) GetEpoch() github_com_prysmaticlabs_eth2_types.Epoch {
	if x != nil {
		return x.Epoch
	}
...
func (x *SkipsyncRequest) GetNextSyncCommittee() *SyncCommittee {
	if x != nil {
		return x.NextSyncCommittee
	}
	return nil
...
type SkipSyncResponse struct {
	...
	Updates *LightClientUpdate `protobuf:"bytes,1,opt,name=updates,proto3" json:"updates,omitempty"`
}
...
func (x *SkipSyncResponse) GetUpdates() *LightClientUpdate {
	if x != nil {
		return x.Updates
	}
	return nil
...
type SkipSyncRequestKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SkipSyncRequestKey) Reset() {
	*x = SkipSyncRequestKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *SkipSyncRequestKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SkipSyncRequestKey) ProtoMessage() {}

func (x *SkipSyncRequestKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_light_client_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SkipSyncRequestKey.ProtoReflect.Descriptor instead.
func (*SkipSyncRequestKey) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_light_client_proto_rawDescGZIP(), []int{5}
}

func (x *SkipSyncRequestKey) GetEpoch() github_com_prysmaticlabs_eth2_types.Epoch {
	if x != nil {
		return x.Epoch
	}
	return github_com_prysmaticlabs_eth2_types.Epoch(0)
...
func (x *SkipSyncRequestKey) GetNextSyncCommittee() *SyncCommittee {
	if x != nil {
		return x.NextSyncCommittee
	}
	return nil
...
var file_proto_prysm_v1alpha1_light_client_proto_rawDesc = []byte{
	...
	0xac, 0x01, 0x0a, 0x0f, 0x53, 0x6b, 0x69, 0x70, 0x73, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x71, 0x75,
	...
	0x68, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x54, 0x0a, 0x13, 0x6e, 0x65, 0x78, 0x74,
	...
	0x74, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x22, 0x56,
	0x0a, 0x10, 0x53, 0x6b, 0x69, 0x70, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x42, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20,
	...
	0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x07, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x12, 0x53, 0x6b, 0x69, 0x70, 0x53,
	0x79, 0x6e, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x43, 0x0a,
	...
	0x63, 0x68, 0x12, 0x54, 0x0a, 0x13, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x73, 0x79, 0x6e, 0x63, 0x5f,
	...
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x32, 0x97, 0x02, 0x0a, 0x0b, 0x4c, 0x69, 0x67,
	0x68, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x75, 0x0a, 0x07, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x26, 0x2e, 0x65, 0x74,
	0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
...
var file_proto_prysm_v1alpha1_light_client_proto_goTypes = []interface{}{
	...
	(*UpdatesResponse)(nil),    // 2: ethereum.eth.v1alpha1.UpdatesResponse
	(*SkipsyncRequest)(nil),    // 3: ethereum.eth.v1alpha1.SkipsyncRequest
	(*SkipSyncResponse)(nil),   // 4: ethereum.eth.v1alpha1.SkipSyncResponse
	(*SkipSyncRequestKey)(nil), // 5: ethereum.eth.v1alpha1.SkipSyncRequestKey
...
var file_proto_prysm_v1alpha1_light_client_proto_depIdxs = []int32{
	6,  // 0: ethereum.eth.v1alpha1.ClientSnapshot.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	7,  // 1: ethereum.eth.v1alpha1.ClientSnapshot.current_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	7,  // 2: ethereum.eth.v1alpha1.ClientSnapshot.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	6,  // 3: ethereum.eth.v1alpha1.LightClientUpdate.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	7,  // 4: ethereum.eth.v1alpha1.LightClientUpdate.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	6,  // 5: ethereum.eth.v1alpha1.LightClientUpdate.finality_header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	1,  // 6: ethereum.eth.v1alpha1.UpdatesResponse.updates:type_name -> ethereum.eth.v1alpha1.LightClientUpdate
	7,  // 7: ethereum.eth.v1alpha1.SkipsyncRequest.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	1,  // 8: ethereum.eth.v1alpha1.SkipSyncResponse.updates:type_name -> ethereum.eth.v1alpha1.LightClientUpdate
	7,  // 9: ethereum.eth.v1alpha1.SkipSyncRequestKey.next_sync_committee:type_name -> ethereum.eth.v1alpha1.SyncCommittee
	8,  // 10: ethereum.eth.v1alpha1.LightClient.Updates:input_type -> google.protobuf.Empty
	3,  // 11: ethereum.eth.v1alpha1.LightClient.SkipSyncUpdate:input_type -> ethereum.eth.v1alpha1.SkipsyncRequest
	2,  // 12: ethereum.eth.v1alpha1.LightClient.Updates:output_type -> ethereum.eth.v1alpha1.UpdatesResponse
	1,  // 13: ethereum.eth.v1alpha1.LightClient.SkipSyncUpdate:output_type -> ethereum.eth.v1alpha1.LightClientUpdate
...
func file_proto_prysm_v1alpha1_light_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_light_client_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SkipSyncRequestKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type LightClientClient interface {
	Updates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UpdatesResponse, error)
	SkipSyncUpdate(ctx context.Context, in *SkipsyncRequest, opts ...grpc.CallOption) (*LightClientUpdate, error)
}
...
func (c *lightClientClient) Updates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UpdatesResponse, error) {
...
func (c *lightClientClient) SkipSyncUpdate(ctx context.Context, in *SkipsyncRequest, opts ...grpc.CallOption) (*LightClientUpdate, error) {
...
func (*UnimplementedLightClientServer) Updates(context.Context, *empty.Empty) (*UpdatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Updates not implemented")
}
func (*UnimplementedLightClientServer) SkipSyncUpdate(context.Context, *SkipsyncRequest) (*LightClientUpdate, error) {
